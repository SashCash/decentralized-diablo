...
export interface CharacterNFTTokenURIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface CharacterNFTTokenURI extends BaseContract {
  connect(runner?: ContractRunner | null): CharacterNFTTokenURI;
  waitForDeployment(): Promise<this>;

  interface: CharacterNFTTokenURIInterface;
