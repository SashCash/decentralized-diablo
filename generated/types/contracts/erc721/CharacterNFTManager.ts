...
export interface CharacterNFTManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "mintCharacterPrivate",
    values: [BigNumberish, AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPricePerMint",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CharacterNFTManager extends BaseContract {
  connect(runner?: ContractRunner | null): CharacterNFTManager;
  waitForDeployment(): Promise<this>;

  interface: CharacterNFTManagerInterface;
  ...
  mintBatch: TypedContractMethod<
    [
      ...
      charTypes: BigNumberish[]
    ],
    [void],
    "nonpayable"
  >;

  mintCharacterPrivate: TypedContractMethod<
    [amount: BigNumberish, to: AddressLike, charType: BigNumberish],
    [void],
    "nonpayable"
  >;

  mintCharacterPublic: TypedContractMethod<
    [amount: BigNumberish, charType: BigNumberish],
    [void],
    "payable"
  >;
  ...
  setPricePerMint: TypedContractMethod<
  ...
  tokenIdToCharacterClass: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "mintCharacterPrivate"
  ): TypedContractMethod<
    [amount: BigNumberish, to: AddressLike, charType: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "mintCharacterPublic"
  ): TypedContractMethod<
    [amount: BigNumberish, charType: BigNumberish],
    [void],
    "payable"
  ...
  getFunction(
    nameOrSignature: "setPricePerMint"
  ): TypedContractMethod<[_pricePerMint: BigNumberish], [void], "nonpayable">;
  getFunction(
